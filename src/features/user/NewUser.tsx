      ...
      <form onSubmit={handleCreateNewUser}>
        ...
        <fieldset className='mb-8'>
          ...
          >
            ...
            <option value='#C09CFF'>purple</option>
            <option value='#92BFFF'>blue</option>
            <option value='#C6F590'>green</option>
            <option value='#F78D5C'>orange</option>
            <option value='#FFDF52'>yellow</option>
          </select>
        </fieldset>
