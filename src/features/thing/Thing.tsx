...
const Thing = ({ thing }: { thing: ThingInterface }) => {
  ...
  return (
    <section className='flex w-full flex-col items-center justify-center gap-8 rounded border-2 border-solid border-black p-8 shadow-[-4px_4px_0_black] dark:border-[#cbd5e1] dark:shadow-[-4px_4px_0_#cbd5e1]'>
